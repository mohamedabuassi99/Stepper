          ...
          @endif
            ...
            <div class="row">
              <div class="col-8">
                ...
                <label for="choice-2">
                  <input type="tel" name="tel" id="choice-2" style="text-align:right; padding-right:-5px;" placeholder="رقم الجوال" @error('tel') class="invalid" @enderror>
               ...
               <label for="choice-5">
                  <input type="number" placeholder="العمر" name="age" id="choice-5" @error('age') class="invalid" @enderror
